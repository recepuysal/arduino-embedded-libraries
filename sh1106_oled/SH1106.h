...
class Sh1106 : public GfxCanvas {
 public:
  enum FontType : uint8_t {
    FontSmall = 0U,   // 5x7
    FontMedium = 1U,  // 6x8 (ayri glif)
    FontLarge = 2U    // 8x12 (olcekleme tabanli)
  };
  ...
  Sh1106(TwoWire& wire, uint8_t address7bit = 0x3C);
 ...
 private:
  ...
  static const uint8_t page_offset = 2U;  // SH1106 RAM offset
